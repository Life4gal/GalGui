...
namespace gal::internal
{
    ...
    struct basic_rect
    {
        ...
        template <typename T1, typename T2, typename T = std::common_type_t<T1, T2>, typename = gal::enable_if_t<gal::is_convertible_v<T1, T2>>>
...
//                   && basic_point<coordinate_type>{right, bottom} == basic_point<coordinate_type>{other.right, other.bottom};
        ...
        {
            return {gal::min(left, other.left), gal::min(top, other.top), gal::max(right, other.right), gal::max(bottom, other.bottom)};
        }
        ...
        {
            return {gal::max(left, other.left), gal::max(top, other.top), gal::min(right, other.right), gal::min(bottom, other.bottom)};
        }
